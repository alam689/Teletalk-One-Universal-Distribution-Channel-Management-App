...
const DRAFTS: Draft[] = [
  ...
  },
  {
    posCode: '30110001',
    role: 'onlineDealer',
    name: ['ডিজিটাল টেলিকম অনলাইন', 'Digital Telecom Online'],
    owner: ['ফারহানা ইয়াসমিন', 'Farhana Yasmin'],
    zone: ['ঢাকা জোন', 'Dhaka Zone'],
    territory: ['অনলাইন চ্যানেল', 'Online channel'],
    msisdn: '8801715220011',
    address: ['বাড়ি ৭, রোড ১১, বনানী, ঢাকা-১২১৩', 'House 7, Road 11, Banani, Dhaka-1213'],
    enlistedOn: '2023-06-21',
    stats: { balance: 48210.75, commissionToday: 640.5 },
  },
  {
    posCode: '30120001',
    role: 'subDealer',
    name: ['মিরপুর সাব-ডিলার পয়েন্ট', 'Mirpur Sub-dealer Point'],
    owner: ['আনিসুর রহমান', 'Anisur Rahman'],
    zone: ['ঢাকা জোন', 'Dhaka Zone'],
    territory: ['মিরপুর-১১', 'Mirpur-11'],
    msisdn: '8801715330022',
    address: ['ব্লক সি, মিরপুর-১১, ঢাকা-১২১৬', 'Block C, Mirpur-11, Dhaka-1216'],
    enlistedOn: '2022-09-08',
    stats: { balance: 15980.2, simStock: 940 },
  },
  {
    posCode: '30030001',
    role: 'fieldOfficer',
